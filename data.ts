...
export const DICTIONARY: Record<Language, TranslationMatrix> = {
  uk: {
    navTitle: "VANTAM",
    navSub: "КООРДИНАЦІЙНИЙ ЦЕНТР НІДЕРЛАНДИ",
    langLabel: "Мова",
    heroBadge: "ОФІЦІЙНИЙ ЛОКАЛЬНИЙ ДЕСК ПІДТРИМКИ",
    ...
    whySub: "Ми живемо в Нідерландах, знаємо мову країни, маємо прямі контакти з державними органами та щоденно вирішуємо реальні побутові питання студентів.",
    ...
    calculatorSub: "Без системного супроводу невеликі пропуски офіційних процедур перетворюються на реальні тисячні штрафи, втрату депозитів та тривалий стрес. Порівняйте потенційні втрати з фіксованою вартістю підтримки VANTAM.",
    calculatorInfo: "Клацайте на прапорці ризиків, щоб змоделювати потенційні витрати студента-одинака.",
    ...
    pdfExportDesc: "Згенеруйте вишуканий PDF-інвойс із вибраним пакетом супроводу VANTAM для демонстрації батькам чи колегам.",
    pdfBtn: "Завантажити PDF-оферту VANTAM",

    statusBanner: "СТАТУС КООРДИНАЦІЙНОГО ЦЕНТРУ VANTAM: ЛОКАЛЬНА ПАКЕТНА ПІДТРИМКА 2026",
    statusScope: "СУПРОВІД ДІЄ ПО ВСІЙ ТЕРИТОРІЇ НІДЕРЛАНДІВ • ОФІЦІЙНИЙ СЛУЖБОВИЙ ДЕСК",
    navWhy: "Чому ми",
    ...
    calcFooterNotice: "Зауваження щодо критеріїв: Розрахунки побудовано на основі офіційної статистики реальних збитків та штрафів іноземних студентів у Нідерландах за сезон 2024-2025 років.",

    calcRiskLow: "Турбулентність низького рівня",
    calcRiskMedium: "Помірна фінансова вразливість",
    calcRiskHigh: "Критична загроза зриву адаптації",
    calcRiskLowDesc: "Ви захистили первинні кроки. Проте дрібні процедурні прогалини все ще можуть ускладнити отримання BSN та затягнути реєстрацію дитини.",
    calcRiskMediumDesc: "Вибірковий захист залишає небезпечні вікна. Наприклад, орендне шахрайство (€1600) є катастрофічним ударом по бюджету студента.",
    calcRiskHighDesc: "Високий рівень фінансової та легальної небезпеки! Ви ризикуєте втратити великі гроші, отримати державні пені та порушити терміни IND.",
    calcRiskTextLabel: "ОЦІНКА РИСКОВОГО СТАТУСУ СТУДЕНТА:",
    ...
    checklistPrepDesc: "PREP TRACK",
    checklistArrivalTab: "2. Перші 72 години",
    checklistArrivalDesc: "ON-SITE TRANSIT",
    checklistSettleTab: "3. Протягом 30 днів",
    checklistSettleDesc: "COMPLIANCE & SETTLE",

    testimonialsTitle: "Історії успішного старту",
    testimonialsSub: "Реальний, невигаданий досвід студентів, експатів та батьків, які довірилися координаторам VANTAM.",
    testimonialsVerified: "Верифікований статус клієнта",

    contactTitle: "Давайте будувати ваш спокій разом",
    contactSub: "Залиште заявку, і наш локальний координатор зв'яжеться з вами протягом 2 годин для безкоштовної первинної оцінки ситуації.",
    ...
    contactSuccessDesc: "Дякуємо! Наш деск у Нідерландах вже взяв у роботу ваші дані. Ми надішлемо вам деталізований фідбек на вказаний Email.",
    contactFailBtn: "Надіслати новий запит",

    modalTitle: "КАБІНЕТ ЕКСПОРТУ ПРОПОЗИЦІЇ VANTAM",
    modalDesc: "Вміст адаптовано для друку або збереження в PDF. Натисніть кнопку запуску нижче.",
    modalOfferNo: "OFFER NO",
    modalValidity: "VALIDITY",
    modalClientProfile: "Профіль отримувача:",
    modalAdvisorDesc: "Офіційна комерційна пропозиція від координаційного центру VANTAM.",
  ...
  ru: {
    navTitle: "VANTAM",
    navSub: "КООРДИНАЦИОННЫЙ СТАТУС КООРДИНАТОРОВ НИДЕРЛАНДЫ",
    langLabel: "Язык",
    heroBadge: "ОФИЦИАЛЬНЫЙ ЛОКАЛЬНЫЙ ДЕСК ПОДДЕРЖКИ",
    ...
    whySub: "Мы живем в Нидерландах, свободно говорим по-голландски, имеем прямые каналы связи с административными органами и решаем вопросы прямо на месте.",
    ...
    calculatorSub: "Без структурированной поддержки мелкие упущения превращаются в тысячи евро штрафов, утерю залогов и высокий уровень стресса. Сравните риски самостоятельно.",
    calculatorInfo: "Выберите потенциальные риски ниже, чтобы увидеть их среднюю стоимость и сравнить с безопасным решением от VANTAM.",
    ...
    pdfExportDesc: "Создайте структурированный PDF-файл вашего выбранного формата услуг VANTAM, чтобы обсудить его со своей семьей или отправить родителям.",
    pdfBtn: "Создать PDF предложение VANTAM",

    statusBanner: "СТАТУС КООРДИНАЦИОННОГО ЦЕНТРА VANTAM: ПОДДЕРЖКА ЛОКАЛЬНЫХ ПАКЕТОВ АКТИВНА 2026",
    statusScope: "РАБОТАЕМ ПО ВСЕЙ ТЕРРИТОРИИ НИДЕРЛАНДОВ • ОФИЦИАЛЬНЫЙ СЕРВИСНЫЙ ДЕСК",
    navWhy: "Почему мы",
    ...
    calcFooterNotice: "Замечания по критериям: Расчеты построены на основе официальной статистики реального ущерба и штрафов иностранных студентов в Нидерландах за сезон 2024-2025 годов.",

    calcRiskLow: "Турбулентность низкого уровня",
    calcRiskMedium: "Умеренная финансовая уязвимость",
    calcRiskHigh: "Критическая угроза срыва адаптации",
    ...
    testimonialsSub: "Реальный, невыдуманный опыт студентов, экспатов и родителей, доверившихся координаторам VANTAM.",
    testimonialsVerified: "Верифицированный статус клиента",

    contactTitle: "Давайте строить ваше спокойствие вместе",
    contactSub: "Оставьте заявку, и наш локальный координатор свяжется с вами в течение 2 часов для бесплатной первичной оценки ситуации.",
    ...
    contactSuccessDesc: "Спасибо! Наш деск в Нидерландах уже взял в работу ваши данные. Мы направим вам детализированный фидбек на указанный Email.",
    contactFailBtn: "Отправить новый запрос",

    modalTitle: "КАБИНЕТ ЭКСПОРТА ПРЕДЛОЖЕНИЯ VANTAM",
    modalDesc: "Содержимое адаптировано для печати или сохранения в PDF. Нажмите кнопку запуска ниже.",
    modalOfferNo: "OFFER NO",
    modalValidity: "VALIDITY",
    modalClientProfile: "Профиль получателя:",
    modalAdvisorDesc: "Официальное коммерческое предложение от координационного центра VANTAM.",
  ...
  en: {
    navTitle: "VANTAM",
    navSub: "NETHERLANDS COORDINATION CENTRE",
    langLabel: "Language",
    heroBadge: "OFFICIAL LOCAL SUPPORT DESK",
    ...
    whyTitle: "Why VANTAM?",
    whySub: "We live in the Netherlands, speak fluent Dutch, maintain direct communications with native authorities, and solve on-site relocation realities daily.",
    ...
    calculatorSub: "Without structured guidance, minor administrative oversights translate into thousands of Euros in penalties, lost deposits, and high anxiety. Review common pitfalls vs. VANTAM.",
    calculatorInfo: "Toggle hypothetical risk items to overlay average financial exposure vs. our secure packages.",
    ...
    pdfExportDesc: "Compile a beautifully structured PDF prospectus of your selected VANTAM setup to share easily with parents or study agency partners.",
    pdfBtn: "Generate VANTAM PDF Proposal",

    statusBanner: "VANTAM COORDINATION CENTRE STATUS: LOCAL PACKAGE SUPPORT ACTIVE 2026",
    statusScope: "WORKS NATIONWIDE ACROSS THE ENTIRE NETHERLANDS • OFFICIAL SERVICE DESK",
    navWhy: "Why Vantam",
    ...
    calcFooterNotice: "Calculation Notes: Estimated risk levels and costs are generated based on actual empirical data of international student struggles in the Netherlands during the 24-25 season.",

    calcRiskLow: "Low Risk Level",
    calcRiskMedium: "Moderate Risk Exposure",
    calcRiskHigh: "Critical Zone Zones Compromised",
    calcRiskLowDesc: "You secured your basic checklist, but small procedural holes can still stall tax registration at your local Gemeente.",
    calcRiskMediumDesc: "Partial coverage leaves key vulnerabilities. Rental fraud (€1,600) remains a catastrophic financial hit for any student.",
    calcRiskHighDesc: "Dangerous risk levels! You risk substantial financial losses, official government penalties, and missing critical IND administrative check-in dates.",
    calcRiskTextLabel: "STUDENT RISK PROFILE STATUS:",
    ...
    testimonialsSub: "Real on-the-ground case studies of families, students, and expats who made their transition seamless with VANTAM.",
    testimonialsVerified: "Verified VANTAM Family Client",

    contactTitle: "Let's Secure Your Landing Together",
    contactSub: "Submit your request below, and our on-the-ground advisor will reach back to you within 2 hours for a complimentary context review.",
    ...
    contactSuccessDesc: "Our Dutch support line has received your details. Expect a structured response directly to your email in under 2 hours.",
    contactFailBtn: "Resubmit Request",

    modalTitle: "VANTAM OFFICIAL OFFER SHEET EXPORTER",
    modalDesc: "The content of this portal has been optimized for printing and PDF generation. Use the control button below to save.",
    modalOfferNo: "OFFER PROSPECTUS NO",
    modalValidity: "VALID UNTIL",
    modalClientProfile: "Client Case Profile:",
    modalAdvisorDesc: "Confidential relocation outline prepared by VANTAM Netherlands Desk.",
...
export const SERVICES_STORE: Record<Language, ServiceColumn[]> = {
  uk: [
    ...
    },
    {
      ...
      sub: "ДОГОВОРИ, ЛИСТИНГИ, КОМУНІКАЦІЯ",
      items: [
  ...
  en: [
    {
      pillar: "ADMIN SETUP",
      sub: "REGISTRATION, BSN, DIGID, BANK",
      items: [
...
export const TESTIMONIALS: Testimonial[] = [
  {
    ...
    avatar: "https://picsum.photos/seed/olga/150/150",
    story: {
  ...
  },
  {
    ...
    avatar: "https://picsum.photos/seed/daniil/150/150",
    story: {
  ...
  },
  {
    ...
    avatar: "https://picsum.photos/seed/kate/150/150",
    story: {
